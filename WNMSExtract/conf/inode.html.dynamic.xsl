				...
				<xsl:choose>
					<xsl:when test="$mi_pos=$m1">
						...
						<xsl:element name="AtmPort">
							...
							<xsl:variable name="p1" select="count((../mt[.='VS.RxMaxCellRate'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p2" select="count((../mt[.='VS.TxMaxCellRate'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p3" select="count((../mt[.='VS.RxAvgCellRate'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p4" select="count((../mt[.='VS.TxAvgCellRate'])[1]/preceding-sibling::*)-1"/>
					...
					<xsl:when test="$mi_pos=$m2">
						...
						<xsl:element name="Lp">
							<xsl:attribute name="id"><xsl:value-of select="$id3"/></xsl:attribute>
							<xsl:variable name="p1" select="count((../mt[.='VS.CpuUtilAvg'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p2" select="count((../mt[.='VS.CpuUtilAvgMax'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p3" select="count((../mt[.='VS.CpuUtilAvgMin'])[1]/preceding-sibling::*)-1"/>
					...
					<xsl:when test="$mi_pos=$m3">
						...
						<xsl:element name="Lp">
							...
							<xsl:element name="Ap">
								...
								<xsl:variable name="p1" select="count((../mt[.='VS.ApCpuUtilizationAvg'])[1]/preceding-sibling::*)-1"/>
					...
					<xsl:when test="$mi_pos=$m4">
						...
						<xsl:element name="Lp">
							...
							<xsl:element name="Ethernet">
								...
								<xsl:variable name="p1" select="count((../mt[.='VS.avgRxUtilization'])[1]/preceding-sibling::*)-1"/>
								<xsl:variable name="p2" select="count((../mt[.='VS.avgTxUtilization'])[1]/preceding-sibling::*)-1"/>
								<xsl:variable name="p3" select="count((../mt[.='VS.maxRxUtilization'])[1]/preceding-sibling::*)-1"/>
								<xsl:variable name="p4" select="count((../mt[.='VS.maxTxUtilization'])[1]/preceding-sibling::*)-1"/>
