...
/**
 * ALU JDC Connectior implemenataion for the test database NPO33. This box has already been theived
 * by IT so this class is no longer used
 * @author jnramsay
 *
 */
public class NPO33JDCConnector implements ALUJDCConnector{

	private static Logger jlog = Logger.getLogger("com.alcatel-lucent.nz.wnmsextract.database.NPO33JDCConnector");
	...
	*/
	...
	public NPO33JDCConnector(ALUConnectionDefinitions cd){
