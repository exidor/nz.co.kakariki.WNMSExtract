...
public class TestParseMapRncVcc extends TestCase{
	String dv1,tv1;
	/**
	...
	protected void setUp() {
		TestDBUtilities.delete("snap_rnc_vcc");
		WNMSTransform t = (new WNMSTransform());
		t.setDocumentType(DocumentType.WIPS_mRVcc);
	 ...
	 */
	@Test
	public void testRead_snap_rnc_vcc(){
		dv1 = TestDBUtilities.select("snap_rnc_vcc","rid");
		System.out.println("<RncVcc>mRVcc::["+dv1+","+tv1+"]");
