-- create type cell3g_bh_container as (id varchar(8), ts timestamp, data double precision);
create or replace function cell3g_bh(timestamp,int,varchar) returns setof cell3g_bh_container as $$  
 select 
	d1.id,
	d1.ts,
	d1.val
