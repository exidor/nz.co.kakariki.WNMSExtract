			...
			<xsl:choose>
				<xsl:when test="$mi_pos=$m1">
					...
					<xsl:element name="VS.CEMUsedDCH.Avg">
						<xsl:apply-templates select="alu:r[position()=63]"/>
					</xsl:element>
				</xsl:when>
				<xsl:when test="$mi_pos=$m2">
					...
					<xsl:element name="BtsCell">
						...
						<xsl:element name="VS.CellULload.Total.Cum">
							<xsl:apply-templates select="alu:r[position()=21]"/>
						</xsl:element>
						<xsl:element name="VS.CellULload.Total.NbEvt">
							<xsl:apply-templates select="alu:r[position()=23]"/>
						</xsl:element>
						<xsl:element name="VS.CellULload.eDCH.Cum">
							<xsl:apply-templates select="alu:r[position()=26]"/>
						</xsl:element>
						<xsl:element name="VS.CellULload.eDCH.NbEvt">
							<xsl:apply-templates select="alu:r[position()=28]"/>
						</xsl:element>
						<xsl:element name="VS.RadioTxCarrierPwr.Used.Avg">
							<xsl:apply-templates select="alu:r[position()=17]"/>
						</xsl:element>
						<xsl:element name="VS.RadioTxCarrierPwr.Oper.Max">
							<xsl:apply-templates select="alu:r[position()=14]"/>
						</xsl:element>
					</xsl:element>
				</xsl:when>
				...
				<xsl:when test="$mi_pos=$m4">
					...
					<xsl:element name="ImaGroup">
						...
						<xsl:element name="VS.imaGroupNbSentCell.Avg">
							<xsl:apply-templates select="alu:r[position()=9]"/>
						</xsl:element>
						...
						<xsl:element name="VS.imaGroupNbSentCell.Max">
							<xsl:apply-templates select="alu:r[position()=11]"/>
						</xsl:element>
					</xsl:element>
				</xsl:when>
