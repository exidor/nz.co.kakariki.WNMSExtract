...
import com.alcatel_lucent.nz.wnmsextract.xmlbeans.wnms.nodeb.CemType;

/*
 drop table raw_nodeb_cem;
...
/**
 * Cem table inserter. Child of Board table
 * @author jnramsay
 */
public class ALUCemTable {

	private static Logger jlog = Logger.getLogger("com.alcatel-lucent.nz.wnmsextract.database.nodeb.ALUCemTable");

	public static final String TABLE_NAME = "raw_nodeb_cem";
