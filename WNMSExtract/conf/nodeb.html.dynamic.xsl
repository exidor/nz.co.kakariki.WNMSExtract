		...
		<xsl:element name="NodeBEquipment">
			...
			<xsl:choose>
				<xsl:when test="$mi_pos=$m1">
					<!-- NBE p=1-->
					<xsl:variable name="p1" select="count((../mt[.='VS.CEMUsedDCH.Avg'])[1]/preceding-sibling::*)-1"/>
				...
				<xsl:when test="$mi_pos=$m2">
					...
					<xsl:element name="BtsCell">
						...
						<xsl:variable name="p1" select="count((../mt[.='VS.CellULload.Total.Cum'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p2" select="count((../mt[.='VS.CellULload.Total.NbEvt'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p3" select="count((../mt[.='VS.CellULload.eDCH.Cum'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p4" select="count((../mt[.='VS.CellULload.eDCH.NbEvt'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p5" select="count((../mt[.='VS.RadioTxCarrierPwr.Used.Avg'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p6" select="count((../mt[.='VS.RadioTxCarrierPwr.Oper.Max'])[1]/preceding-sibling::*)-1"/>
				...
				<xsl:when test="$mi_pos=$m3">
					...
					<xsl:element name="PassiveComponent">
						...
						<xsl:element name="PA">
							...
							<xsl:variable name="p1" select="count((../mt[.='VS.PAPwr.Avg'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p2" select="count((../mt[.='VS.PAPwr.Max'])[1]/preceding-sibling::*)-1"/>
				...
				<xsl:when test="$mi_pos=$m4">
					...
					<xsl:element name="ImaGroup">
						<xsl:attribute name="id"><xsl:value-of select="$id2"/></xsl:attribute>
						<xsl:variable name="p1" select="count((../mt[.='VS.imaGroupNbReceivedCell.Avg'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p2" select="count((../mt[.='VS.imaGroupNbSentCell.Avg'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p3" select="count((../mt[.='VS.imaGroupNbReceivedCell.Max'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p4" select="count((../mt[.='VS.imaGroupNbSentCell.Max'])[1]/preceding-sibling::*)-1"/>
				...
				<xsl:when test="$mi_pos=$m5">
					...
					<xsl:element name="IpRan">
						<xsl:attribute name="id"><xsl:value-of select="$id2"/></xsl:attribute>
						<xsl:variable name="p1" select="count((../mt[.='VS.ifOutOctets'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p2" select="count((../mt[.='VS.ifOutUserPlaneOctets'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p3" select="count((../mt[.='VS.ifInOctets'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p4" select="count((../mt[.='VS.ifInUserPlaneOctets'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p5" select="count((../mt[.='VS.ifInNUcastPkts'])[1]/preceding-sibling::*)-1"/>
						<xsl:variable name="p6" select="count((../mt[.='VS.ifInUcastPkts'])[1]/preceding-sibling::*)-1"/>
				...
				<xsl:when test="$mi_pos=$m6">
					...
					<xsl:element name="Board">
						...
						<xsl:element name="Ccm">
							<xsl:attribute name="id"><xsl:value-of select="$id3"/></xsl:attribute>
							<xsl:variable name="p1" select="count((../mt[.='VS.cpuLoad.Max'])[1]/preceding-sibling::*)-1"/>
				...
				<xsl:when test="$mi_pos=$m8">
					...
					<xsl:element name="BtsCell">
						...
						<xsl:element name="HSDPAService">
							<xsl:attribute name="id"><xsl:value-of select="$id3"/></xsl:attribute>
							<xsl:variable name="p1" select="count((../mt[.='VS.HsdpaReceivedCQI.Level0'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p2" select="count((../mt[.='VS.HsdpaReceivedCQI.Level1'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p3" select="count((../mt[.='VS.HsdpaReceivedCQI.Level2'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p4" select="count((../mt[.='VS.HsdpaReceivedCQI.Level3'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p5" select="count((../mt[.='VS.HsdpaReceivedCQI.Level4'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p6" select="count((../mt[.='VS.HsdpaReceivedCQI.Level5'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p7" select="count((../mt[.='VS.HsdpaReceivedCQI.Level6'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p8" select="count((../mt[.='VS.HsdpaReceivedCQI.Level7'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p9" select="count((../mt[.='VS.HsdpaReceivedCQI.Level8'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p10" select="count((../mt[.='VS.HsdpaReceivedCQI.Level9'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p11" select="count((../mt[.='VS.HsdpaReceivedCQI.Level10'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p12" select="count((../mt[.='VS.HsdpaReceivedCQI.Level11'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p13" select="count((../mt[.='VS.HsdpaReceivedCQI.Level12'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p14" select="count((../mt[.='VS.HsdpaReceivedCQI.Level13'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p15" select="count((../mt[.='VS.HsdpaReceivedCQI.Level14'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p16" select="count((../mt[.='VS.HsdpaReceivedCQI.Level15'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p17" select="count((../mt[.='VS.HsdpaReceivedCQI.Level16'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p18" select="count((../mt[.='VS.HsdpaReceivedCQI.Level17'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p19" select="count((../mt[.='VS.HsdpaReceivedCQI.Level18'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p20" select="count((../mt[.='VS.HsdpaReceivedCQI.Level19'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p21" select="count((../mt[.='VS.HsdpaReceivedCQI.Level20'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p22" select="count((../mt[.='VS.HsdpaReceivedCQI.Level21'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p23" select="count((../mt[.='VS.HsdpaReceivedCQI.Level22'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p24" select="count((../mt[.='VS.HsdpaReceivedCQI.Level23'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p25" select="count((../mt[.='VS.HsdpaReceivedCQI.Level24'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p26" select="count((../mt[.='VS.HsdpaReceivedCQI.Level25'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p27" select="count((../mt[.='VS.HsdpaReceivedCQI.Level26'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p28" select="count((../mt[.='VS.HsdpaReceivedCQI.Level27'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p29" select="count((../mt[.='VS.HsdpaReceivedCQI.Level28'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p30" select="count((../mt[.='VS.HsdpaReceivedCQI.Level29'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p31" select="count((../mt[.='VS.HsdpaReceivedCQI.Level30'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p32" select="count((../mt[.='VS.HsdpaTxDataBitsMAChs.Cum'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p33" select="count((../mt[.='VS.HsdpaTTIsUsed'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p34" select="count((../mt[.='VS.HsdpaTxDataBitPerUEcat.UEcat6'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p35" select="count((../mt[.='VS.HsdpaTTIperUEcat.UEcat6'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p36" select="count((../mt[.='VS.HsdpaTxDataBitPerUEcat.UEcat8'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p37" select="count((../mt[.='VS.HsdpaTTIperUEcat.UEcat8'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p38" select="count((../mt[.='VS.HsdpaTxDataBitPerUEcat.UEcat10'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p39" select="count((../mt[.='VS.HsdpaTTIperUEcat.UEcat10'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p40" select="count((../mt[.='VS.HsdpaTxDataBitPerUEcat.UEcat14'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p41" select="count((../mt[.='VS.HsdpaTTIperUEcat.UEcat14'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p42" select="count((../mt[.='VS.HsdpaTxDataBitPerUEcat.UEcat15'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p43" select="count((../mt[.='VS.HsdpaTTIperUEcat.UEcat15'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p44" select="count((../mt[.='VS.HsdpaTxDataBitPerUEcat.UEcat16'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p45" select="count((../mt[.='VS.HsdpaTTIperUEcat.UEcat16'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p46" select="count((../mt[.='VS.HsdpaTxDataBitPerUEcat.UEcat17'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p47" select="count((../mt[.='VS.HsdpaTTIperUEcat.UEcat17'])[1]/preceding-sibling::*)-1"/>
				...
				<xsl:when test="$mi_pos=$m9">
					...
					<xsl:element name="BtsCell">
						...
						<xsl:element name="HSUPAService">
							<xsl:attribute name="id"><xsl:value-of select="$id3"/></xsl:attribute>
							<xsl:variable name="p1" select="count((../mt[.='VS.eDCHdataBitSentToRNC.Cum'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p2" select="count((../mt[.='VS.eDCHactiveUsers.2ms_users.Cum'])[1]/preceding-sibling::*)-1"/>
							<xsl:variable name="p3" select="count((../mt[.='VS.eDCHactiveUsers.10ms_users.Cum'])[1]/preceding-sibling::*)-1"/>
