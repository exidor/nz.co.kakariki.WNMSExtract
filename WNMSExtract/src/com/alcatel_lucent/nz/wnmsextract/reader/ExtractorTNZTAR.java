...
@Deprecated
public class ExtractorTNZTAR extends Extractor {

	private static Logger jlog = Logger.getLogger("com.alcatel_lucent.nz.wnmsextract.schedule.ExtractorTNZTAR");

	public ExtractorTNZTAR(){
	...
	@Override
	public String toString(){return "TAR Extractor ";}//+cal;}
